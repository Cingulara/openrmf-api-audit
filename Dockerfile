...
ENTRYPOINT ["./openrmf-api-audit"]

LABEL org.opencontainers.image.source=https://github.com/Cingulara/openrmf-api-audit
LABEL org.opencontainers.image.authors="dale.bingham@cingulara.com"
LABEL org.opencontainers.image.description="This is the audit internal API to capture audit requests to list data captured by the audit message client for OpenRMF OSS"
LABEL org.opencontainers.image.vendor="Cingulara LLC and Tutela LLC"
LABEL org.opencontainers.image.title="OpenRMF OSS Audit internal API"